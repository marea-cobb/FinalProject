...
Mutation confers a lifetime risk of breast cancer of 50-85% an ovarian cancer of 15-45%
...
```{r}
Remove Outliers
outlier <- function(ppt){
  ematrix2<-ematrix2[ematrix2[,ppt] < 20,] 
}
ematrix2<-ematrix
ematrix2<-ematrix2[ematrix2[,1] < 20,]
ematrix2<-ematrix2[ematrix2[,2] < 20,]
ematrix2<-ematrix2[ematrix2[,3] < 20,]
ematrix2<-ematrix2[ematrix2[,4] < 20,]
ematrix2<-ematrix2[ematrix2[,5] < 20,]
ematrix2<-ematrix2[ematrix2[,6] < 20,]
ematrix2<-ematrix2[ematrix2[,7] < 20,]
ematrix2<-ematrix2[ematrix2[,8] < 20,]
ematrix2<-ematrix2[ematrix2[,9] < 20,]
ematrix2<-ematrix2[ematrix2[,10] < 20,]
ematrix2<-ematrix2[ematrix2[,11] < 20,]
ematrix2<-ematrix2[ematrix2[,12] < 20,]
ematrix2<-ematrix2[ematrix2[,13] < 20,]
ematrix2<-ematrix2[ematrix2[,14] < 20,]
ematrix2<-ematrix2[ematrix2[,15] < 20,]
